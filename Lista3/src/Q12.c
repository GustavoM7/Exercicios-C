/*
Q12 - Lista 3
Escreva um programa que implemente a dinâmica do jogo utilizando uma matriz.
O programa deve permitir que os dois jogadores intercalem suas jogadas e avise quando houve um
ganhador.
*/
